...
:class:`NewStackLayout` arranges children vertically or horizontally, as many
...
class NewStackLayout(Layout):
    ...
    def __init__(self, **kwargs):
        super(NewStackLayout, self).__init__(**kwargs)
        self.bind(
